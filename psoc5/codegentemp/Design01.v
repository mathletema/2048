...
module SPI_Master_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("4b2caa0a-3972-4c4c-be49-87598d3c3b4b/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
...
module ADC_DelSig_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("27ed16e1-445c-42e3-b884-ec0f2cd97ddf/82a282b1-0d17-42bb-9978-e80dd3a9497a/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("27ed16e1-445c-42e3-b884-ec0f2cd97ddf/82a282b1-0d17-42bb-9978-e80dd3a9497a/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
// ResistiveTouch_v2_0(ADC=ADC, ADC_Select=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ResistiveTouch_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TouchScreen, CY_INSTANCE_SHORT_NAME=TouchScreen, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=TouchScreen, )
module ResistiveTouch_v2_0_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("27ed16e1-445c-42e3-b884-ec0f2cd97ddf/610968b3-67fb-4685-8915-5e2cfb8dc1ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("27ed16e1-445c-42e3-b884-ec0f2cd97ddf/cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("27ed16e1-445c-42e3-b884-ec0f2cd97ddf/91aa62e6-33b1-4270-8506-d74f01f597ef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("27ed16e1-445c-42e3-b884-ec0f2cd97ddf/61ba0d4a-fea9-4b6e-95f3-8c7abcc27aa6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0e83f6c2-b5b3-4c1d-823b-be50b1facd91"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b07a6ca0-e861-4493-ba90-c1830646e959"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("34758e24-ce8e-4c11-8d9e-c66c33ab156c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9b02e657-acf4-48c9-8c8c-6376ea0e597a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("14b8813d-29ad-4df4-a391-0899a30b030b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [3:0] tmpOE__Input_Data_net;
	wire [3:0] tmpIO_3__Input_Data_net;
	wire [0:0] tmpINTERRUPT_0__Input_Data_net;
	electrical [0:0] tmpSIOVREF__Input_Data_net;

	cy_psoc3_pins_v1_10
		#(.id("492a5a63-46f8-40f9-be27-5b5c59965c72"),
		...
		Input_Data
		 (.oe(tmpOE__Input_Data_net),
		  .y({4'b0}),
		  .fb({Net_49, Net_48, Net_47, Net_46}),
		  .io({tmpIO_3__Input_Data_net[3:0]}),
		  .siovref(tmpSIOVREF__Input_Data_net),
		  .interrupt({tmpINTERRUPT_0__Input_Data_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Input_Data_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
	...
	cy_psoc3_pins_v1_10
		#(.id("bf192aed-aa9f-46d8-b6f0-71d2dd95e3c3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Data_Available_net;
	wire [0:0] tmpIO_0__Data_Available_net;
	wire [0:0] tmpINTERRUPT_0__Data_Available_net;
	electrical [0:0] tmpSIOVREF__Data_Available_net;

	cy_psoc3_pins_v1_10
		#(.id("06bf99d3-bb14-4829-819c-036edf791cdb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Data_Available
		 (.oe(tmpOE__Data_Available_net),
		  .y({1'b0}),
		  .fb({Net_50}),
		  .io({tmpIO_0__Data_Available_net[0:0]}),
		  .siovref(tmpSIOVREF__Data_Available_net),
		  .interrupt({tmpINTERRUPT_0__Data_Available_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Data_Available_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ResistiveTouch_v2_0_2 TouchScreen ();
