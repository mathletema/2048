...
#define BS_UDB_1_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000200u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000280u)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000288u)

/* IOPINS0_2 Address: CYREG_PRT2_DR Size (bytes): 10 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000290u)
...
uint8 CYXDATA * const CYCODE TouchScreen_ADC_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE TouchScreen_ADC_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: TouchScreen_ADC_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void TouchScreen_ADC_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*TouchScreen_ADC_AMux__addrTable[channel] |= TouchScreen_ADC_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: TouchScreen_ADC_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void TouchScreen_ADC_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*TouchScreen_ADC_AMux__addrTable[channel] &= (uint8)~TouchScreen_ADC_AMux__maskTable[channel];
	}
}

int8 TouchScreen_AMux_curChannel = -1;

void TouchScreen_AMux_DisconnectAll(void)
{
	TouchScreen_AMux_curChannel = -1;
...
{
	TouchScreen_AMux_curChannel++;
	switch (TouchScreen_AMux_curChannel)
	{
	case 3: /* to force jump table (not executed) */
		TouchScreen_AMux_curChannel = 3;
	case 4: /* to force jump table (not executed) */
		TouchScreen_AMux_curChannel = 4;
	case 5: /* to force jump table (not executed) */
		TouchScreen_AMux_curChannel = 5;
	case 6: /* to force jump table (not executed) */
		TouchScreen_AMux_curChannel = 6;
	case 7: /* to force jump table (not executed) */
		TouchScreen_AMux_curChannel = 7;
	case 2:
	default:
		TouchScreen_AMux_curChannel = 0;
	case 0:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, 0x04u);
		CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW0, 0x04u);
		break;
	case 1:
		CY_SET_REG8((void CYXDATA *)CYREG_PRT2_AG, 0x01u);
